...
class MqttHandler(logging.Handler):
    def __init__(self, topic='robust/'+os.environ['APPDIR'], hostname='localhost', port=1883):
        super().__init__()
        self.topic = topic
        self.client = mqtt.Client(callback_api_version=mqtt.CallbackAPIVersion.VERSION2, client_id='robust' + str(os.getpid()), protocol=mqtt.MQTTv311)

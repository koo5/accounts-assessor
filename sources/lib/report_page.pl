...
/* write file and return Url */
 ...
 add_report_page_with_body__singleton(Report_Uri, Priority, Title, Body_Html, File_Name, Key) :-
	page_with_body(Title, Body_Html, Page_Html),
	add_report_page__singleton(Report_Uri, Priority, Title, Page_Html, File_Name, Key).

 add_report_page_with_body(Report_Uri, Priority, Title, Body_Html, File_Name, Key) :-
	page_with_body(Title, Body_Html, Page_Html),
	add_report_page(Report_Uri, Priority, Title, Page_Html, File_Name, Key).
...
% todo refactor, pass loc(file_name, singleton('xxx')) ?
 add_report_page__singleton(Report_Uri, Priority, Title, Page_Html, File_Name, Key) :-
	...
	add_report_file(Report_Uri, Priority, Key, Title, Url).
...
% todo ^
 ...
 add_report_page_with_table(Report_Uri, Priority, Title, Tbl, File_Name, Key) :-
	page_with_table_html(Title, Tbl, Html),
	add_report_page(Report_Uri, Priority, Title, Html, File_Name, Key).
